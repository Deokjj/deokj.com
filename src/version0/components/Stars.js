...
class Circle{
  ...
  constructor (ctx, width, height, rint) {
  ...
  draw = function() {
    ...
    this.g.addColorStop(0.0, 'rgba(252,228,236,'+newo+')');
    this.g.addColorStop(this.stop, 'rgba(244,144,177,'+(newo*.2)+')');
    this.g.addColorStop(1.0, 'rgba(244,144,177,0)');
